...
class UserUserDataset:
    ...
    def _create_user_article_dataframe(self):
        ...
        self.user_article_interaction = self.user_article_interaction.drop_duplicates(subset=['ID_CommunityIdentity', 'ID_Article'])
    ...
    def outsource_information(self):
        """
        Returns:
            user_article_interaction: pd.DataFrame with user-article interactions
            users_mapping: dict with user_id to user_enc mapping
            articles_mapping: dict with article_id to article_enc mapping
        """        
        
        return self.user_article_interaction, self.users_mapping, self.articles_mapping
